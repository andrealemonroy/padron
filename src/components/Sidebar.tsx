        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Proyectos */}
              <SidebarLinkGroup
                activecondition={pathname.includes('proyectos')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* Trabajador */}
              <SidebarLinkGroup
                activecondition={pathname.includes('trabajador')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* RRHH */}
              <SidebarLinkGroup activecondition={pathname.includes('rrhh')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Nóminas */}
              <SidebarLinkGroup activecondition={pathname.includes('nominas')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Evaluación */}
              <SidebarLinkGroup
                activecondition={pathname.includes('evaluacion')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* Contratos */}
              <SidebarLinkGroup
                activecondition={pathname.includes('contratos')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* Reportes */}
              <SidebarLinkGroup activecondition={pathname.includes('reportes')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Usuarios */}
              <SidebarLinkGroup
                activecondition={pathname.includes('configuracion')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
