...
import { fetchEducation, editEducation, createEducation, fetchEducationsLevel, fetchCareers, fetchInss } from '../api/EducationsApi';
...
const CreateEducations = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      if (id) {
        await editEducation(data, Number(id), tipoAccion);
      } else {
        await createEducation({ ...data, accion: 'grabar' });
      }
      setError(null);
      navigate('/educations');
    } catch (error) {
