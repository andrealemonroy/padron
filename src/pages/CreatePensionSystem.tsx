...
import { fetchPensionSystems, editPensionSystems, fetchPensionLine, createPensionSystems } from '../api/pensionSystemApi';
...
const CreatePensionSystem = () => {
  ...
  const onSubmit = async (data) => {
    try {
      if (id) {
        await editPensionSystems(data, Number(id), tipoAccion);
      } else {
        await createPensionSystems({ ...data, accion: 'grabar' });
      }
      setError(null);
